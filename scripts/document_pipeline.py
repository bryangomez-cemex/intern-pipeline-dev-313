...
# Required candidate document set (stage C). acta de nacimiento is optional.
REQUIRED_CANDIDATE_DOCS = ["alta", "curp", "constancia", "identificacion", "foto"]
...
def classify_document_type(local_path, filename):
    ...
    if ext in (".png", ".jpg", ".jpeg"):
        # an ID photo or a scanned doc; default to foto unless the name says otherwise
